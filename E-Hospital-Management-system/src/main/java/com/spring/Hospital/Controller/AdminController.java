...
public class AdminController {
	...
	@RequestMapping("/pharma-details")
	public String pharmaDetails(Model model){
		...
		List<Admin> list=adminServiceImplementation.findByRole("ROLE_PHARMA");
		
		
		
		// add to the spring model
		model.addAttribute("pharma", list);
		
		
		return "admin/pharma";
	}
	
	@RequestMapping("/labtest-details")
	public String labtestDetails(Model model){
		...
		List<Admin> list=adminServiceImplementation.findByRole("ROLE_LABTEST");
		
		
		
		// add to the spring model
		model.addAttribute("labtest", list);
		
		
		return "admin/labtest";
	}
	@GetMapping("/add-labtest")
	public String showAddLabtest(Model theModel) {
		...
		theModel.addAttribute("labtest", admin);
		
		return "admin/addLabtest";
	}
	...
	public String saveLabtest(@ModelAttribute("labtest") Admin admin) {
		
		// save the employee
	//	admin.setId(0);
		
		admin.setRole("ROLE_LABTEST");
	...
	public String showFormForAddDepart(Model theModel) {
		...
		theModel.addAttribute("depart", depart);
	...
	@PostMapping("/save-depart")
	public String saveDepart(@ModelAttribute("depart") Department  depart) {
	...
	public String showFormAdd(Model theModel) {
		...
		theModel.addAttribute("pharma", admin);
		
		return "admin/addPharma";
	}
	@PostMapping("/save-pharma")
	public String savePharma(@ModelAttribute("pharma") Admin admin) {
		
		// save the employee
	//	admin.setId(0);
		
		admin.setRole("ROLE_PHARMA");
		
		admin.setPassword("pharma");
